...
def test_invalid_score_request(arguments, get_response, set_valid_auth):
    request = {
        'account': 'horns&hoofs',
        'login': 'h&f',
        'method': 'online_score',
...
def test_ok_score_request(arguments, get_response, set_valid_auth, context):
    request = {
        'account': 'horns&hoofs',
        'login': 'h&f',
        'method': 'online_score',
...
def test_ok_score_admin_request(get_response, set_valid_auth):
